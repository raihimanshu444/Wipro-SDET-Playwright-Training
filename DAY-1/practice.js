...
console.log("Object:", obj);  //{ name: 'Alice', age: 30, city: 'New York' }
console.log("Name:", obj.name); //Alice
console.log("Age:", obj.age);  // 30
console.log("City:", obj.city);  //New York
...
// Element at index after * 2  0 : 2
// Element at index after * 2  1 : 4
// Element at index after * 2  2 : 6
// Element at index after * 2  3 : 8
// Element at index after * 2  4 : 10
